    ...
    <div id="content-wrapper">
      ...
      <div class="container-fluid">
        ...
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active">Search Directory</li>
        </ol>
            ...
            <div class="form-row">
              <div class="col-md-12">
                <div class="form-label-group">
                  ...
                  <label for="firstName">Search by Barcode or Name</label>
                </div>
              </div>
              </div></div>
...
<thead>
              ...
              <th>Item Name</th>
               ...
               <?php
$ret=mysqli_query($con,"select * from tbldirectory where ItemBarcode like '%$sdata%' || ItemName like '%$sdata%' ");
