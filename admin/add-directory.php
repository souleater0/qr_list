...
if (strlen($_SESSION['pdaid']) == 0) {
  ...
  if (isset($_POST['submit'])) {
    ...
    $query = "INSERT INTO tbldirectory (ItemBarcode, ItemName, ItemDesc, Status) VALUES ('$itembarcode', '$itemname', '$itemdesc', '$admsta')";
        ...
        <div id="content-wrapper">
            <div class="container-fluid">
                ...
                <form name="directory" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-row">
                            ...
                            <div class="col-md-6">
                                <div class="form-label-group">
                                    <input type="text" id="itemname" name="itemname" class="form-control" required="required">
                                    <label for="item Name">Item Name</label>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-label-group">
                                    <input type="text" id="itembarcode" name="itembarcode" class="form-control" required="required" autofocus="autofocus">
                    ...
                    <div class="form-group">
                        <div class="form-label-group">
                            <input type="text" id="itemdesc" name="itemdesc" class="form-control" required="required">
