        ...
        <!-- DataTables Example -->
          ...
          <div class="form-group">
            <div class="form-row">
              ...
              <div class="col-md-6">
                <div class="form-label-group">
                  <input type="text" id="mobilenumber" name="mobilenumber" class="form-control"  required="required"  maxlength="10" value="<?php echo $row['MobileNumber'];?>">
          ...
          <div class="form-group">
            <div class="form-row">
              <div class="col-md-12">
                <div class="form-label-group">
                  <input type="text" id="adminregdate" name="adminregdate"  class="form-control"  required="required" value="<?php echo $row['AdminRegdate'];?>">
